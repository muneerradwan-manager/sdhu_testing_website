...
export const PRINCIPLES = [
  ...
  { title: "تسجيلان منفصلان للقبول", text: "تسجيل على القبول المباشر بالأكبر سناً (35% من الحصة)، ثم تسجيل مستقل بطلب جديد على قرعة علنية (65%) تُعتمد نتائجها وتُنشر مع سجل كامل." },
