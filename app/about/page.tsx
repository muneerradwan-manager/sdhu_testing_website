        ...
        <div className="grid items-center gap-12 lg:grid-cols-2">
          <Reveal>
            ...
            <p className="mt-6 text-lg leading-9 text-ink-soft">
              من قرب الجامع الأموي في دمشق تنطلق كل عام رحلة آلاف الحجاج السوريين. نحن الجهة التي تنظّم هذه الرحلة: نفتح التسجيل، ونقبل الحجاج
              بالأكبر سناً ثم بالقرعة العلنية، ونؤهّل الإداريين، ونعتمد التكتلات، ونرافق الحجاج في مكة والمدينة والمشاعر حتى يعودوا.
            </p>
