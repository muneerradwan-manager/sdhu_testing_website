...
const FIXED = [
  ...
  { icon: HeartPulse, title: "غير مصاب بمرض عضال", text: "حفاظاً على سلامة الحاج. لا يُسأل عنه عند التسجيل: يتحقق منه الفريق الطبي بعد القبول من الملف الصحي الذي يسجّله منسق المجموعة." },
];
