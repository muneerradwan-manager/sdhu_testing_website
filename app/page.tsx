...
const TICKER = [
  `التسجيل على القبول المباشر (الأكبر سناً) لموسم حج 1448هـ: ${SEASON.windows.direct.hijri}`,
  `التسجيل على القرعة بطلب مستقل: ${SEASON.windows.lottery.hijri} — والقرعة يوم 1 شعبان الساعة 20:00 ببث مباشر`,
  "تحذير: لا توجد مقاعد مضمونة مقابل مبالغ مالية — تحقق من الجهات المعتمدة عبر المنصة",
  "رسم التسجيل 25 دولاراً للفرد، مع إيصال رقمي قابل للتحقق",
        ...
        <div className="mx-auto max-w-7xl px-4 md:px-8">
          ...
          <Stagger className="grid grid-cols-2 gap-4 md:grid-cols-4">
            {[
              ...
              { n: 72_420, label: "متقدماً للقبول المباشر", sub: "حتى إغلاق التسجيل 1 رجب" },
