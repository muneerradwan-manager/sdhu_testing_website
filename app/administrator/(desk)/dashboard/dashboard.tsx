...
const NEXT: Record<string, { title: string; text: string; cta: string }> = {
  ...
  group: { title: "شكّل مجموعتك", text: "طلب تشكيل المجموعة ضمن تكتل، واختيار الفريق، ورسم 200 $ — حتى 25 جمادى الأولى.", cta: "طلب تشكيل مجموعة" },
  approval: { title: "طلب المجموعة قيد الاعتماد", text: "يراجعه ماهر عيسى ثم يعتمده مدير المكتب مازن الحلبي.", cta: "متابعة الطلب" },
  contracts: { title: "العقود جاهزة للتوقيع", text: "عقد المجموعة مع التكتل، وعقد فريق المجموعة — توقيع إلكتروني.", cta: "توقيع العقود" },
  requests: { title: "طلبات الانتساب بانتظارك", text: "راجع العائلات واحتياجاتها الخاصة وسعة مجموعتك قبل القبول.", cta: "فتح الطلبات" },
